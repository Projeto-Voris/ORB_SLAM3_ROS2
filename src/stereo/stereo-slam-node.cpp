...
: Node("ORB_SLAM3_ROS2"), m_SLAM(pSLAM), node_(node)
{
    ...
    left_sub = std::make_shared<message_filters::Subscriber<ImageMsg>>(node_, "/sm2_left/image_raw");
    right_sub = std::make_shared<message_filters::Subscriber<ImageMsg>>(node_, "/sm2_right/image_raw");
