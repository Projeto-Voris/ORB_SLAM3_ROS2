...
int main(int argc, char **argv)
{
    ...
    auto slam_node = std::make_shared<MonoInertialNode>(&pSLAM, node.get(), options);
    std::cout << "============================" << std::endl;
...
MonoInertialNode::MonoInertialNode(ORB_SLAM3::System *pSLAM, rclcpp::Node* node, rclcpp::NodeOptions options) :
